...
int main() {
    // ----------------------------------------------------------------------------------------------------------------------------------------
    {
        ...
        //      Daher wird bei der ersten Ausgabe die Matrix ausgabe() aufgerufen, da "M" eine reine Matrixinstanz ist und der Mpointer eine Referenz auf eine Vector2d-instanz ist.
